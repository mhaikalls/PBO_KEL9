...
public class Form_Kurir extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Status Pengiriman");
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        String no = String.valueOf(txtno.getText());
        String nama = String.valueOf(txtnama.getText());
        String alamat = String.valueOf(txtalamat.getText());
        String kota = String.valueOf(txtkota.getText());
        String provinsi = String.valueOf(txtprovinsi.getText());
        String kodepos = String.valueOf(txtkodepos.getText());
        String daerah = String.valueOf(txtdaerah.getText());
        String telepon = String.valueOf(txttelepon.getText());
        try {
            String sql = "insert into tb_pengirim(no_pengirim,nama_pengirim,alamat,kota,provinsi,kodepos,daerah,telepon)value ("
